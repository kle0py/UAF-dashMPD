...
try:
    inputMPD = input("dashMPD file (serialized)\nInput: ").strip('"')
        ...
        for a in range(periodNumber):
            ...
            for b in range(adaptationSetNumber):
                ...
                if subsegmentAlignment == 0:
                    ...
                    print("There is something wrong with 'subsegmentAlignment'.")
                ...
                if bitstreamSwitching == 0:
                    ...
                    print("There is something wrong with 'bitstreamSwitching'.")
    ...
    print(f"'{outputMPD}' has been deserialized!")
