# hello :)
print("Welcome to the UbiArt Framework \033[34m.mpd\033[0m file \033[1mcooker\033[0m!")
...
def parseDuration(dashTime):
    ...
    raise ValueError("\033[31mUnsupported time format!\033[0m")

try:
    inputMPD = input("dashMPD file (\033[34m.mpd\033[0m)\nInput: ").strip('"')
    print("\nLog:")
    ...
    print(f"'{outputMPD}' \033[32mhas been successfully cooked!\033[0m")
